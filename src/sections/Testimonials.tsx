  ...
  return (
    <div className="py-16 lg:py-24">
      <div className="container">
        ...
        />
        <div className="mt-16 lg:mt-24 flex overflow-x-clip [mask-image: linear-gradient(to_right, transparent, black_10%, black90%, transparent)]">
          <div className="flex gap-8 flex-none">
            {testimonials.map((testimonial) => (
              <Card
                className="text-[var(--color-opposite-text)] mt-2 max-w-xs md:p-8 md:max-w-md lg:max-w-md"
